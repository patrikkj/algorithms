...
def mini_batch_gradient_descent(params, X, y, cost_func, grad_func, alpha=0.01, epochs=100, k=64, step_func=None, **hparams):
...
def batch_gradient_descent(params, X, y, cost_func, grad_func, alpha=0.01, epochs=100):
    ...
    Returns:
        ...
        grads (ndarray[n, epochs]):         gradients for each batch iteration
    """
    return mini_batch_gradient_descent(params, X, y, cost_func, grad_func, alpha, epochs, X.shape[0])
...
def momentum_gradient_descent(params, X, y, cost_func, grad_func, alpha=0.01, epochs=100, k=64, beta=0.9):
...
def rmsprop(params, X, y, cost_func, grad_func, alpha=0.01, epochs=100, k=64, beta=0.9):
...
def adam(params, X, y, cost_func, grad_func, alpha=0.01, epochs=100, k=64, beta1=0.9, beta2=0.999, epsilon=10e-8):
